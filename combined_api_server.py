#!/usr/bin/env python3
"""
COMBINED API SERVER: Documentation + Agentic AI
Includes: Docstring generation, README generation, AND AI agents
Start: python combined_api_server.py
...
# ============================================================================
# Load Agentic AI Agents (from template)
# ============================================================================
try:
    ...
    print("Warning: Agentic template not fully loaded. Install requirements: pip install -r app_requirements.txt")
...
app = FastAPI(
    ...
    description="Combined API: Docstring generation + AI agents",
    version="1.0.0"
)
...
async def root():
    ...
    return {
        ...
        "systems": {
            "documentation": {
                "docstring_generation": "Auto-generate docstrings",
                "readme_generation": "Auto-generate README files"
            },
            "agentic_ai": {
                "gemini_direct": "Direct Gemini API calls",
                "agentic_framework": "Agents with tools"
            }
        },
        "endpoints": {
            "docs": "http://localhost:8002/docs",
            "documentation": [
                "POST /upload - Single file docstrings",
                "POST /batch - Multiple files docstrings",
                "POST /generate-readme - Generate README"
            ],
            "agentic_ai": [
                "POST /genai/chat - Chat with Gemini",
                "POST /genai/agent - Use agentic framework"
            ] if agentic_loaded else []
        }
    }

@app.post("/upload")
async def upload_file(file: UploadFile = File(...)):
    """Upload Python file and generate docstrings"""
    try:
...
async def batch_process(files: list[UploadFile] = File(...)):
    """Upload multiple Python files and generate docstrings"""
    try:
        results = []
        for file in files:
            if not file.filename.endswith('.py'):
...
# ============================================================================
# AGENTIC AI ENDPOINTS (if template loaded)
# ============================================================================
...
if __name__ == "__main__":
    import uvicorn
    print("=" * 70)
    print("🚀 COMBINED API SERVER: Documentation + AI Agents")
    print("=" * 70)
    print("\n📚 DOCUMENTATION SYSTEM (Docstrings + README)")
